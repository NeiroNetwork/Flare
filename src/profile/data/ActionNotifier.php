...
class ActionNotifier{
	...
	public function notifyUpdate(Closure $closure) : void{
		Utils::validateCallableSignature(function(ActionRecord $record, bool $flag) : void{}, $closure);

		$this->onUpdate[] = $closure;
	}

	public function notifyEnd(Closure $closure) : void{
		Utils::validateCallableSignature(function(ActionRecord $record) : void{}, $closure);
